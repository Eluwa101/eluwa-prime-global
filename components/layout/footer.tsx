...
import { companyProfile, navigationItems, services, socialLinks } from "@/data/site-content";
        ...
        <div className="site-footer__about">
          ...
          <div className="site-footer__social">
            <Link
              ...
              aria-label="Eluwa Monday on LinkedIn"
            ...
            <Link
              ...
              target="_blank"
              rel="noreferrer noopener"
              aria-label="Eluwa Prime Global on X (Twitter)"
              className="social-icon-link"
            >
              <XIcon />
            </Link>
            <Link
              ...
              target="_blank"
              rel="noreferrer noopener"
              aria-label="Eluwa Prime Global on Facebook"
              className="social-icon-link"
            >
              <FacebookIcon />
            </Link>
            <Link
              ...
              target="_blank"
              rel="noreferrer noopener"
              aria-label="Message Eluwa Prime Global on WhatsApp"
              className="social-icon-link"
            >
              <WhatsAppIcon />
            </Link>
