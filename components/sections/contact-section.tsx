      ...
      <div className="container contact-section__grid">
        <Reveal className="contact-section__content">
          <SectionHeading
            ...
            description="Tell us what you need and we will help shape the right engagement, whether that starts with software, infrastructure, AI integration, or digital growth."
          />

          <form
            className="contact-form"
            action="https://formspree.io/f/xanwjlnd"
            method="POST"
          >
            <input type="hidden" name="_subject" value="New enquiry — Eluwa Prime Global" />
